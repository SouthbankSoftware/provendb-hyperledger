...
function networkUp() {
  ...
  COMPOSE_FILES="-f ${COMPOSE_FILE_BASE} -f ${COMPOSE_FILE_EXPLORER}"
...
function networkDown() {
  ...
  docker-compose -f $COMPOSE_FILE_BASE -f $COMPOSE_FILE_COUCH -f $COMPOSE_FILE_CA -f $COMPOSE_FILE_EXPLORER down --volumes --remove-orphans
